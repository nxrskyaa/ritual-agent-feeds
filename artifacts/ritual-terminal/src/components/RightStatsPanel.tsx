...
export default function RightStatsPanel() {
  ...
  return (
    <aside className="hidden xl:flex flex-col w-[280px] h-screen sticky top-0 glass border-l border-[var(--terminal-border)] p-5 overflow-y-auto">
      {/* Header */}
      <div className="mb-6">
        ...
        <p className="label">Real-time stats from Ritual</p>
      </div>
      ...
      <div className="card p-4" style={{ borderLeft: '3px solid var(--mint)' }}>
        ...
        <p className="label">Ritual Testnet · Chain 1979</p>
      </div>
